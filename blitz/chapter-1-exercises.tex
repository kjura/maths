...
\begin{equation*}
    2^n
\end{equation*}
Now, consider tackling this problem from a different angle. We know that there are \(n\) experiments in total.
So we can choose sequentially choose the number of combinations 
