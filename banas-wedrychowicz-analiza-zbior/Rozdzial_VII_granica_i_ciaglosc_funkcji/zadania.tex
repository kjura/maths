...
\end{equation*}
\begin{equation*}
    = \lim_{x \to 0} \frac{\Big(\sqrt{x^2 + 1} - \sqrt{x + 1}\Big)(1 + \sqrt{x + 1})}{-x} \frac{(1 - \sqrt{x + 1})}{(1 - \sqrt{x + 1})}\frac{(\sqrt{x^2 + 1} + \sqrt{x + 1})}{(\sqrt{x^2 + 1} + \sqrt{x + 1})}
\end{equation*}
\begin{equation*}
    = \lim_{x \to 0} \frac{(x^2 + 1 -x - 1)(1 - x - 1)}{-x(1 - \sqrt{x + 1})(\sqrt{x^2 + 1} + \sqrt{x + 1})}
\end{equation*}
\begin{equation*}
    = \lim_{x \to 0}\frac{(x^2 + 1 -x - 1)}{(1 - \sqrt{x + 1})(\sqrt{x^2 + 1} + \sqrt{x + 1})}
\end{equation*}
\begin{equation*}
    = \frac{0^2 + 1 - 0 - 1}{(\dots)} \neq 0
\end{equation*}
