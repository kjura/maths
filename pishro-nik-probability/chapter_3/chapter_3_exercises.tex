...
\end{equation*}
\begin{equation*}
    = 0.32767999999999986 \approx 0.32768
\end{equation*}
...
\end{equation*}
\begin{equation*}
    = \frac{1}{5}\sum_{k=3}^{6}(\frac{4}{5})^{k-1} = 0.3778560000000001 \approx 0.377856
\end{equation*}
...
\end{equation*}
\begin{equation*}
    = 1 - \frac{\frac{1}{5}\sum_{k=1}^{5}(\frac{4}{5})^{k-1}}{\frac{1}{5}\sum_{k=1}^{8}(\frac{4}{5})^{k-1} - \Big(\frac{1}{5}(1-\frac{1}{5})^{8-1}\Big)}
\end{equation*}
...
Let \(X \sim Hypergeometric(10, 10, 12)\):
