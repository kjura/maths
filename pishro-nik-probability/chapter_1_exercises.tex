...
Niech \( A_n = \bigcup_{n=2}^{\infty} [0, \frac{n - 1}{n})\). Mamy wtedy:

\begin{equation*}
    x \in A_n 
\end{equation*}
\begin{equation*}
    \implies x \in [0, 1 - \frac{1}{n}) \ \ \mbox{dla pewnego} \ \ n \geq 2
\end{equation*}
\begin{equation*}
    \implies 0 \leq x < 1 - \frac{1}{n} \ \ \mbox{dla pewnego} \ \ n \geq 2
\end{equation*}
\begin{equation*}
    \implies 0 \leq x < 1 - \frac{1}{n} < 1 \ \ \mbox{dla pewnego} \ \ n \geq 2
\end{equation*}
\begin{equation*}
    \implies x \in [0, 1)
\end{equation*}
