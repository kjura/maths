...
\begin{enumerate}
    \item Czemu \(A \neq \emptyset\) i \(B \neq \emptyset\)?
    \item Tutaj jak jest rozumowanie nie wprost to sprzecznie zakładamy, że istnieja jakiś \(c\) który nie jest w \(C\)?
    \item Czemu \(A \subset (- \infty, c)\) oraz \(B \subset (c, + \infty)\)?
    \item Czy \((- \infty, c]\) i \([c, + \infty)\) to są domknięcia zbiorów \((- \infty, c)\) i \((c, + \infty)\)?
    \item Czemu \(\overline{A} \subset (- \infty, c] \) i \(\overline{B} \subset [c, +\infty)\)?
    \item Dlaczego \(\overline{A} \cap B \subset (-\infty, c] \cap (c, + \infty) = \emptyset \) i stąd \(\overline{A} \cap B = \emptyset\)?
    \item Czemu \(C = A \cup B\)?
\end{enumerate}
...
Tutaj niepewnie ale dlatego (z pytajnikiem), że jeśli
