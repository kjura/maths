...
\subsection*{Definicja ciągowa (Heinego)}
...
\begin{itemize}
    \item Czy najpierw trzeba pokazać istnienie punktu skupienia? Czy on jest nieodłączną częścią granicy (stoi przy \(x \to x_0\))
    \item Czy za każdym razem gdy wciągamy z czegoś granicę to pokazujemy, że coś jest punktem skupienia?
    \item Jak wygląda definicja punktu izolowanego przy negacji? (\emph{taki który nie jest punktem skupienia})
\end{itemize}
