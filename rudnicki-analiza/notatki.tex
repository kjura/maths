...
\begin{itemize}
    ...
    \item Technika dowodu -> przypuszczenie o nie istnieniu granicy w punkcie a użycie podciągu - jak to działa?
    \item Czemu \(\overline{x} \neq x_0\) gdy wybieramy podciąg podciągu?
    \item Czemu \(y_{r_n} = f(x_{r_n})\)? \(r_n\), to indeksy z ciągu kompletnie niepowiązanego, tak?
